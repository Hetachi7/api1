package com.example.appisimpson.views.adapters
...
import com.example.appisimpson.R
...
class adapter(
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val vista = LayoutInflater.from(parent.context).inflate(R.layout.iteam_rv_personajes, parent, false)
